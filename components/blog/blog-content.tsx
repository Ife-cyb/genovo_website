...
export default function BlogContent() {
  ...
  const posts = [
    ...
    {
      title: "Taskr Development Update: Q4 2024 Progress",
      excerpt:
        "Progress report on our service marketplace platform, including new features, user feedback, upcoming milestones, and market expansion plans.",
