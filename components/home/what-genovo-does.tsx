...
export default function WhatGenovoDoes() {
  const services = [
    {
      icon: Shield,
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-6">What Genovo Does</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We create elite software solutions that span secure infrastructure, AI platforms, and next-generation
            digital experiences that prioritize privacy and user sovereignty.
          </p>
        </div>
